...
def test_client_protocol_version_is_canonical() -> None:
    ...
    assert CLIENT_PROTOCOL_VERSION == "1.5.0"
...
def test_mismatched_worker_protocol_version_raises() -> None:
    """A worker enforcing 99.0.0 must reject the 1.5.0 client at dispatch."""
    ...
    # Directional hint: the client (1.5.0) is older than the worker (99.0.0).
