...
class TestCLICatalogList:
    ...
    def test_catalog_list_shows_example(self, fixture_worker: str) -> None:
        """Catalog list shows 'example' catalog."""
        runner = CliRunner()
        result = runner.invoke(
            cli,
            ["catalog", "list", "--worker", fixture_worker],
        )
...
class TestCLISchemaContents:
    ...
    def test_schema_contents_lists_table_functions(self, fixture_worker: str) -> None:
    ...
    def test_schema_contents_requires_type(self, fixture_worker: str) -> None:
    ...
    def test_schema_contents_with_catalog_option(self, fixture_worker: str) -> None:
    ...
    def test_all_example_functions_present(self, fixture_worker: str) -> None:
        ...
        # Parse function names from all three results
        function_names: set[str] = set()
        for result in [table_result, scalar_result, aggregate_result]:
    ...
    def test_function_info_has_correct_structure(self, fixture_worker: str) -> None:
    ...
    def test_scalar_functions_have_correct_type(self, fixture_worker: str) -> None:
    ...
    def test_table_functions_have_correct_type(self, fixture_worker: str) -> None:
...
class TestCLISchemaList:
    ...
    def test_schema_list_shows_main(self, fixture_worker: str) -> None:
