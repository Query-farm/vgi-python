...
class TestClientLifecycle:
    ...
    def test_context_manager(self, fixture_worker: str) -> None:
    ...
    def test_start_when_already_started_raises(self, fixture_worker: str) -> None:
    ...
    def test_stop_when_not_started_raises(self, fixture_worker: str) -> None:
        """Stopping a client that wasn't started should raise ClientError."""
        client = Client(fixture_worker)
        with pytest.raises(ClientError, match="not started"):
            client.stop()

    def test_table_in_out_function_not_started_raises(self, fixture_worker: str) -> None:
...
class TestEdgeCases:
    ...
    def test_empty_batch_with_aggregation(self, fixture_worker: str) -> None:
    ...
    def test_single_row_batch(self, fixture_worker: str) -> None:
    ...
    def test_large_batch_count(self, fixture_worker: str) -> None:
...
class TestWorkerStderrCapture:
    ...
    def test_stderr_empty_initially(self, fixture_worker: str) -> None:
