...
class TestMultiplyFunction:
    ...
    def test_multiply_basic(self, example_worker: str) -> None:
    ...
    def test_multiply_by_one(self, example_worker: str) -> None:
    ...
    def test_multiply_empty_batch(self, example_worker: str) -> None:
