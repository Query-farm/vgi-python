...
class TestSchemaIntegration:
    """Integration tests combining schema utilities with VGI patterns."""

    def test_schema_with_function(self) -> None:
        """schema() can be used in a function's output_schema property."""
        import structlog
        ...
        class TestFunction(TableInOutFunction):
            ...
            def output_schema(self) -> pa.Schema:
                return schema(sum=pa.int64(), count=pa.int64())
    ...
    def test_schema_like_with_function(self) -> None:
        """schema_like() can derive output schema from input schema."""
        import structlog
