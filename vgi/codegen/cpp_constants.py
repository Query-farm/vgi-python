...
from vgi.codegen._common import vgi_python_sha
...
def emit(out: TextIO) -> None:
    ...
    out.write("// ============================================================================\n")
    out.write("// GENERATED by vgi.codegen.cpp_constants. DO NOT EDIT BY HAND.\n")
    out.write("//\n")
    out.write(f"// Generator: vgi-gen-cpp-constants v{GENERATOR_VERSION}\n")
    out.write(f"// vgi-python SHA: {sha}\n")
    out.write("//\n")
    out.write("// To regenerate:\n")
    out.write("//   uv run --project ~/Development/vgi-python vgi-gen-cpp-constants \\\n")
    out.write("//     > ~/Development/vgi/src/generated/vgi_protocol_constants.hpp\n")
    out.write("// ============================================================================\n")
    out.write("\n")
    ...
    for entry in _CONSTANTS:
        ...
        for doc_line in entry.description.split("\n"):
            out.write(f"// {doc_line}\n")
        out.write(f"// Sourced from vgi_rpc.metadata.{entry.python_name}.\n")
        out.write(f"inline constexpr std::string_view {entry.cpp_name} = {_as_escaped_cxx_string(value)};\n\n")
