...
def emit(out: "TextIO") -> None:
    ...
    body_blocks = [_emit_var(es) for es in schemas]

    out.write("// Code generated by vgi.codegen.go_schemas. DO NOT EDIT.\n")
    out.write("//\n")
    out.write(f"// Generator: vgi-gen-go-schemas v{GENERATOR_VERSION}\n")
    out.write(f"// vgi-python SHA: {sha}\n")
    out.write("//\n")
    out.write("// To regenerate:\n")
    out.write("//   uv run --project ~/Development/vgi-python vgi-gen-go-schemas \\\n")
    out.write("//     > ~/Development/vgi-go/vgi/generated/protocol_schemas.go\n")
    out.write("\n")
    out.write("// © Copyright 2025-2026, Query.Farm LLC - https://query.farm\n")
    out.write("// SPDX-License-Identifier: Apache-2.0\n")
    out.write("\n")
    out.write("package generated\n")
    out.write("\n")
    out.write('import (\n\t"github.com/apache/arrow-go/v18/arrow"\n)\n')
    out.write("\n")
    out.write("var _ = arrow.BinaryTypes.String // keep import live when no schemas reference it\n")
    out.write("\n")
