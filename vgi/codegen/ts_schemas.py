...
def emit(out: "TextIO") -> None:
    ...
    out.write("// ============================================================================\n")
    out.write("// GENERATED by vgi.codegen.ts_schemas. DO NOT EDIT BY HAND.\n")
    out.write("//\n")
    out.write(f"// Generator: vgi-gen-ts-schemas v{GENERATOR_VERSION}\n")
    out.write(f"// vgi-python SHA: {sha}\n")
    out.write("//\n")
    out.write("// To regenerate:\n")
    out.write("//   uv run --project ~/Development/vgi-python vgi-gen-ts-schemas \\\n")
    out.write("//     > ~/Development/vgi-typescript/src/generated/vgi-protocol-schemas.ts\n")
    out.write("// ============================================================================\n")
    out.write("\n")
    out.write("import {\n")
    for sym in imports:
        out.write(f"  {sym},\n")
    out.write('} from "@query-farm/apache-arrow";\n\n')
