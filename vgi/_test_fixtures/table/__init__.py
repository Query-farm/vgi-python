...
* :mod:`.splits`          — split_sequence / split_zero / split_empty_ranges /
                            split_skewed / split_many (split-based scans)
...
from vgi._test_fixtures.table.cache import (
    ...
    CachePartitionMultiColFunction,
    CachePartitionParallelFunction,
    CachePartitionProjFunction,
    CachePartitionScopeFunction,
    CachePoisonFunction,
